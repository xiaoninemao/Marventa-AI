...
import { fetch_notifications, mark_all_notifications_read, mark_notification_read } from "@/services/api_client";
...
export default function NotificationCenter() {
  ...
  useEffect(() => {
    ...
    const interval = window.setInterval(() => void loadNotifications(), 1_000);
